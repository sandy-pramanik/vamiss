...
# true effect size
pss.true = cbind.data.frame('pull' = 100)
...
for(r in 1:5){
  ...
  saveRDS(list('Mmat.obs' = Mmat.obs,
               ...
               'csmf.outsample_calib' = outsample$p_calib), file.path(output_dir, paste0('truem0_r', r)))
...
saveRDS(list('nCause' = nCause, 'allcauses' = allcauses,
        ...
        file.path(output_dir, 'truem0_datagen'))
